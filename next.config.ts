...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    // CSP is dynamic (per-request nonce) and lives in src/middleware.ts.
    return [
      {
        source: '/:path*',
        headers: [
  ...
  async redirects() {
    return [
      ...
      { source: '/fashion-apparel', destination: '/services/shopify/fashion-apparel', permanent: true },
      { source: '/beauty-cosmetics', destination: '/services/shopify/beauty-cosmetics', permanent: true },
      { source: '/food-beverages', destination: '/services/shopify/food-beverage', permanent: true },
      { source: '/food-beverages-2', destination: '/services/shopify/food-beverage', permanent: true },
      { source: '/health-nutrition', destination: '/services/shopify/health-wellness', permanent: true },
      { source: '/health-nutrition-new', destination: '/services/shopify/health-wellness', permanent: true },
      { source: '/pet-industry', destination: '/services/shopify/pets', permanent: true },
      { source: '/shoes-page', destination: '/services/shopify/fashion-apparel', permanent: true },
      { source: '/wine-page', destination: '/services/shopify/food-beverage', permanent: true },
      // Old combined health-beauty page split into two dedicated pages
      { source: '/services/shopify/health-beauty', destination: '/services/shopify/beauty-cosmetics', permanent: true },
