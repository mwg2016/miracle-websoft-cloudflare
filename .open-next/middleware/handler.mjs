...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 42: (a) => {
      ...
      "use strict";
      let d, e, f;
      c.r(b), c.d(b, { default: () => cB, handler: () => cA });
      var g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v = {};
      async function w() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(v), c.d(v, { config: () => cu, middleware: () => ct });
      let x = null;
      async function y() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function cl(a10) {
        let b10 = "buffer" in a10 ? new Uint8Array(a10.buffer, a10.byteOffset, a10.byteLength) : new Uint8Array(a10), c2 = "";
        for (let a11 of b10) c2 += a11.toString(16).padStart(2, "0");
        return c2;
      }
      async function cm(a10) {
        {
          let b10 = new TextEncoder().encode(a10);
          return cl(await crypto.subtle.digest("SHA-256", b10));
        }
      }
      c(259);
      class cn {
        ...
        constructor({ fs: a10, dev: b10, flushToDisk: c2, minimalMode: d2, serverDistDir: e2, requestHeaders: f2, maxMemoryCacheSize: g2, getPrerenderManifest: h2, fetchCacheKeyPrefix: i2, CurCacheHandler: j2, allowedRevalidateHeaderKeys: k2 }) {
          ...
          if (j2) cn.debug && console.log("IncrementalCache: using custom cache handler", j2.name);
          else {
            const b11 = q2[p2];
            (null == b11 ? void 0 : b11.FetchCache) ? (j2 = b11.FetchCache, cn.debug && console.log("IncrementalCache: using global FetchCache cache handler")) : a10 && e2 && (cn.debug && console.log("IncrementalCache: using filesystem cache handler"), j2 = cf);
          }
        ...
        async lock(a10) {
          for (; ; ) {
            ...
            if (cn.debug && console.log("IncrementalCache: lock get", a10, !!b11), !b11) break;
            await b11;
          }
          let { resolve: b10, promise: c2 } = new b2();
          return cn.debug && console.log("IncrementalCache: successfully locked", a10), this.locks.set(a10, c2), () => {
        ...
        async generateSimpleCacheKey(a10) {
          return cm(JSON.stringify(["v4", this.fetchCacheKeyPrefix || "", a10]));
        }
        async generateCacheKey(a10, b10 = {}) {
          let c2 = [], d2 = new TextEncoder(), e2 = null, f2 = b10.body;
          if (f2) if ("object" == typeof f2 && "byteLength" in f2) c2.push(`bytes:${cl(f2)}`), b10._ogBody = f2;
          else if ("function" == typeof f2.getReader) {
            let a11 = [];
            try {
              await f2.pipeTo(new WritableStream({ write(b11) {
                a11.push("string" == typeof b11 ? d2.encode(b11) : b11);
              } }));
              let e3 = a11.reduce((a12, b11) => a12 + b11.length, 0), g3 = new Uint8Array(e3), h2 = 0;
              for (let b11 of a11) g3.set(b11, h2), h2 += b11.length;
              c2.push(`bytes:${cl(g3)}`), b10._ogBody = g3;
            } catch (a12) {
              console.error("Problem reading body", a12);
            }
          } else if ("function" == typeof f2.keys) for (let [a11, d3] of (e2 = "[object FormData]" === String(f2) ? "multipart/form-data; boundary=" : "application/x-www-form-urlencoded;charset=UTF-8", b10._ogBody = f2, f2.entries())) c2.push(`key:${a11}`), "string" == typeof d3 ? c2.push(`str:${d3}`) : c2.push("file", d3.name, d3.type, `bytes:${cl(await d3.arrayBuffer())}`);
          else if ("function" == typeof f2.arrayBuffer) {
            let a11 = await f2.arrayBuffer();
            c2.push("blob", f2.type, `bytes:${cl(a11)}`), b10._ogBody = new Blob([a11], { type: f2.type }), e2 = f2.type;
          } else if ("string" == typeof f2) c2.push(`str:${f2}`), b10._ogBody = f2, e2 = "text/plain;charset=UTF-8";
          else throw Object.defineProperty(Error(`Unsupported body type: ${typeof f2}`), "__NEXT_ERROR_CODE", { value: "E1145", enumerable: false, configurable: true });
          let g2 = "function" == typeof (b10.headers || {}).keys ? Object.fromEntries(b10.headers) : Object.assign({}, b10.headers);
          return "traceparent" in g2 && delete g2.traceparent, "tracestate" in g2 && delete g2.tracestate, cm(JSON.stringify(["v4", this.fetchCacheKeyPrefix || "", a10, b10.method, e2, g2, b10.mode, b10.redirect, b10.credentials, b10.referrer, b10.referrerPolicy, b10.integrity, b10.cache, c2]));
        }
        async get(a10, b10) {
          ...
          if (b10.kind === bW.FETCH) {
            ...
            if (d3) {
              ...
              if ((null == c4 ? void 0 : c4.kind) === bV.FETCH) {
                ...
                })) return cn.debug && console.log("IncrementalCache: rdc:hit", a10), { isStale: false, value: c4 };
                cn.debug && console.log("IncrementalCache: rdc:revalidated-tag", a10);
              } else cn.debug && console.log("IncrementalCache: rdc:miss", a10);
            } else cn.debug && console.log("IncrementalCache: rdc:no-resume-data");
          }
          ...
          if (b10.kind === bW.FETCH) {
            ...
            })) return cn.debug && console.log("IncrementalCache: expired tag", a10), null;
            let g3 = a8.getStore();
            if (g3) {
              let b11 = a9(g3);
              b11 && (cn.debug && console.log("IncrementalCache: rdc:set", a10), b11.fetch.set(a10, l2.value));
            }
        ...
        async set(a10, b10, c2) {
          if ((null == b10 ? void 0 : b10.kind) === bV.FETCH) {
            ...
            d3 && (cn.debug && console.log("IncrementalCache: rdc:set", a10), d3.fetch.set(a10, b10));
          }
      ...
      var co = c(345);
      if (/* @__PURE__ */ new WeakMap(), co.unstable_postpone, false === ("Route %%% needs to bail out of prerendering at this point because it used ^^^. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error".includes("needs to bail out of prerendering at this point because it used") && "Route %%% needs to bail out of prerendering at this point because it used ^^^. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error".includes("Learn more: https://nextjs.org/docs/messages/ppr-caught-error"))) throw Object.defineProperty(Error("Invariant: isDynamicPostpone misidentified a postpone reason. This is a bug in Next.js"), "__NEXT_ERROR_CODE", { value: "E296", enumerable: false, configurable: true });
      function cp(a10) {
        let b10 = a10.length % 4 == 0 ? "" : "=".repeat(4 - a10.length % 4), c2 = atob(a10.replace(/-/g, "+").replace(/_/g, "/") + b10), d2 = new Uint8Array(c2.length);
        for (let a11 = 0; a11 < c2.length; a11++) d2[a11] = c2.charCodeAt(a11);
        return d2;
      }
      async function cq(a10, b10) {
        let c2 = await crypto.subtle.importKey("raw", new TextEncoder().encode(a10), { name: "HMAC", hash: "SHA-256" }, false, ["sign"]);
        return new Uint8Array(await crypto.subtle.sign("HMAC", c2, new TextEncoder().encode(b10)));
      }
      async function cr(a10, b10) {
        if (!a10) return false;
        let [c2, d2] = a10.split(".");
        if (!c2 || !d2) return false;
        try {
          let a11 = await cq(b10, c2), e2 = cp(d2);
          if (!function(a12, b11) {
            if (a12.length !== b11.length) return false;
            let c3 = 0;
            for (let d3 = 0; d3 < a12.length; d3++) c3 |= a12[d3] ^ b11[d3];
            return 0 === c3;
          }(a11, e2)) return false;
          let f2 = JSON.parse(new TextDecoder().decode(cp(c2)));
          return "number" == typeof f2.exp && f2.exp > Date.now();
        } catch {
          return false;
        }
      }
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]");
      let cs = ["com", "co.uk", "co.in", "com.au", "ca", "de", "fr", "es", "it", "nl", "com.br", "co.jp", "co.kr", "com.mx", "com.sg", "com.hk", "com.tw", "se", "no", "dk", "fi", "pl", "ie", "ch", "at", "be", "pt", "gr", "ro", "cz", "hu", "com.ph", "com.vn", "com.my", "co.th", "co.id", "co.nz", "co.za", "com.ar", "com.tr", "cl", "com.eg", "com.sa", "ae", "com.pk", "com.bd", "lk"].map((a10) => `https://www.google.${a10}`).join(" ");
      async function ct(a10) {
        let b10, { pathname: c2 } = a10.nextUrl, d2 = (b10 = new Uint8Array(16), crypto.getRandomValues(b10), btoa(String.fromCharCode(...b10))), e2 = `default-src 'self'; script-src 'self' 'nonce-${d2}' 'strict-dynamic' https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https:; font-src 'self' https: data:; connect-src 'self' ${cs} https://www.googleadservices.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://stats.g.doubleclick.net https://*.doubleclick.net https://www.googletagmanager.com https://*.googletagmanager.com https://*.facebook.com https://*.facebook.net https://*.clarity.ms https://c.bing.com; frame-src https://www.youtube.com https://www.youtube-nocookie.com https://www.googletagmanager.com https://td.doubleclick.net https://*.facebook.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'; require-trusted-types-for 'script'; trusted-types * 'allow-duplicates'; upgrade-insecure-requests`, f2 = () => {
          var b11;
          let c3;
          return (c3 = new Headers(a10.headers)).set("x-pathname", a10.nextUrl.pathname), c3.set("x-nonce", d2), c3.set("Content-Security-Policy", e2), b11 = ak.next({ request: { headers: c3 } }), b11.headers.set("Content-Security-Policy", e2), b11;
        };
        if (!(c2.startsWith("/admin") || c2.startsWith("/api/admin")) || "/admin/login" === c2 || "/api/admin/login" === c2 || "/api/admin/logout" === c2) return f2();
        let g2 = process.env.ADMIN_SECRET;
        if (!g2) return new ak("Admin disabled (ADMIN_SECRET not set)", { status: 503 });
        let h2 = a10.cookies.get("mw_admin")?.value;
        if (!await cr(h2, g2)) {
          if (c2.startsWith("/api/")) return ak.json({ ok: false, error: "Unauthorized" }, { status: 401 });
          let b11 = a10.nextUrl.clone();
          return b11.pathname = "/admin/login", b11.searchParams.set("next", c2), ak.redirect(b11);
        }
        return f2();
      }
      let cu = { matcher: ["/((?!_next/static|_next/image|favicon.ico|icon.png|apple-icon.png).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let cv = { ...v }, cw = "/src/middleware", cx = (0, cv.middleware || cv.default);
      class cy extends Error {
        constructor(a10) {
          super(a10), this.stack = "";
        }
      }
      if ("function" != typeof cx) throw new cy(`The Middleware file "${cw}" must export a function named \`middleware\` or a default function.`);
      let cz = (a10) => bJ({ ...a10, IncrementalCache: cn, incrementalCacheHandler: null, page: cw, handler: async (...a11) => {
        try {
          return await cx(...a11);
        } catch (e2) {
      ...
      async function cA(a10, b10) {
        let c2 = await cz({ request: { url: a10.url, method: a10.method, headers: N(a10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: cw }, body: "GET" !== a10.method && "HEAD" !== a10.method ? a10.body ?? void 0 : void 0, waitUntil: b10.waitUntil, requestMeta: b10.requestMeta, signal: b10.signal || new AbortController().signal } });
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|icon.png|apple-icon.png).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var ConfigHeaders = [{ "source": "/:path*", "headers": [{ "key": "Strict-Transport-Security", "value": "max-age=63072000; includeSubDomains; preload" }, { "key": "X-DNS-Prefetch-Control", "value": "on" }, { "key": "X-Content-Type-Options", "value": "nosniff" }, { "key": "Referrer-Policy", "value": "strict-origin-when-cross-origin" }, { "key": "Cross-Origin-Opener-Policy", "value": "same-origin-allow-popups" }, { "key": "X-Frame-Options", "value": "DENY" }, { "key": "X-Permitted-Cross-Domain-Policies", "value": "none" }, { "key": "Permissions-Policy", "value": "camera=(), microphone=(), geolocation=(), browsing-topics=(), interest-cohort=()" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }];
