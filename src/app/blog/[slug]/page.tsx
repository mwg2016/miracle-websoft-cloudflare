        ...
        <div className="mw-container" style={{ maxWidth: '780px' }}>
          ...
          <div className="flex items-center gap-3 mb-10 pb-10" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.35)' }}>Founder · Miracle Websoft · Shopify Expert since 2015</div>
            </div>
          </div>
          ...
          <div style={{ background: 'rgba(108,99,255,0.06)', border: '1px solid rgba(108,99,255,0.15)', borderRadius: '20px', padding: '2rem', marginBottom: '3rem' }}>
            ...
            <p style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.7, marginBottom: '1.25rem' }}>We build, optimise and grow Shopify stores for fashion brands. Get a free audit and see exactly what we would change on your store.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {prev && (
              <Link href={`/blog/${prev.slug}`} className="mw-card group" style={{ padding: '1.25rem 1.5rem', display: 'block' }}>
                <div style={{ fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: '0.5rem' }}>← Older post</div>
            ...
            {next && (
              <Link href={`/blog/${next.slug}`} className="mw-card group" style={{ padding: '1.25rem 1.5rem', display: 'block', textAlign: 'right', marginLeft: prev ? undefined : 'auto' }}>
                <div style={{ fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: '0.5rem' }}>Newer post →</div>
          ...
          <div className="mt-8">
            <Link href="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.82rem', color: 'rgba(255,255,255,0.4)' }} className="hover:text-white transition-colors">
