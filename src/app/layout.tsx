...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable}`}>
      ...
      <body>
        <Script id="clarity" strategy="beforeInteractive">{`(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window, document, "clarity", "script", "mbw7qvm2wb");`}</Script>
        ...
        <Script src="https://www.googletagmanager.com/gtag/js?id=AW-18095762557" strategy="afterInteractive" />
        <Script id="gads-init" strategy="afterInteractive">{`gtag('config','AW-18095762557');`}</Script>
