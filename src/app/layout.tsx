...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://www.miraclewebsoft.com'),
  ...
  authors: [{ name: 'Miracle Websoft', url: 'https://www.miraclewebsoft.com' }],
...
const navigationItems = [
  { name: 'Home', url: 'https://www.miraclewebsoft.com' },
  { name: 'Services', url: 'https://www.miraclewebsoft.com/services' },
  { name: 'AI Services', url: 'https://www.miraclewebsoft.com/services/ai' },
  { name: 'Shopify Services', url: 'https://www.miraclewebsoft.com/services/shopify' },
  { name: 'Shopify Development', url: 'https://www.miraclewebsoft.com/services/shopify/development' },
  { name: 'Shopify App Development', url: 'https://www.miraclewebsoft.com/services/shopify-app-development' },
  { name: 'Shopify Migration', url: 'https://www.miraclewebsoft.com/services/shopify-migration' },
  { name: 'Conversion Rate Optimization', url: 'https://www.miraclewebsoft.com/services/conversion-rate-optimization' },
  { name: 'Shopify Speed Optimization', url: 'https://www.miraclewebsoft.com/services/shopify-speed-optimization' },
  { name: 'CRO & Speed Optimisation', url: 'https://www.miraclewebsoft.com/services/shopify-cro-speed' },
  { name: 'Custom Web Development', url: 'https://www.miraclewebsoft.com/services/custom-web-development' },
  { name: 'Industries', url: 'https://www.miraclewebsoft.com/industries' },
  { name: 'Pricing', url: 'https://www.miraclewebsoft.com/pricing' },
  { name: 'Work', url: 'https://www.miraclewebsoft.com/work' },
  { name: 'Reviews', url: 'https://www.miraclewebsoft.com/reviews' },
  { name: 'Case Studies', url: 'https://www.miraclewebsoft.com/case-studies' },
  { name: 'Resources', url: 'https://www.miraclewebsoft.com/resources' },
  { name: 'Blog', url: 'https://www.miraclewebsoft.com/blog' },
  { name: 'About', url: 'https://www.miraclewebsoft.com/about' },
  { name: 'Contact', url: 'https://www.miraclewebsoft.com/contact' },
]
...
const jsonLd = {
  ...
  '@graph': [
    // ── Organisation ──────────────────────────────────────────────────────────
    {
      ...
      '@id': 'https://www.miraclewebsoft.com/#organization',
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://www.miraclewebsoft.com/icon-512.png',
        width: 512,
        height: 512,
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'AI Services',                    url: 'https://www.miraclewebsoft.com/services/ai' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'AI Business Automation',        url: 'https://www.miraclewebsoft.com/services/ai/ai-business-automation' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'OpenAI Integrations',           url: 'https://www.miraclewebsoft.com/services/ai/openai-integrations' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Shopify Services',              url: 'https://www.miraclewebsoft.com/services/shopify' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Custom Shopify Development',    url: 'https://www.miraclewebsoft.com/services/shopify/development' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Shopify Plus Development',      url: 'https://www.miraclewebsoft.com/services/shopify/shopify-plus-development' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Shopify App Development',       url: 'https://www.miraclewebsoft.com/services/shopify-app-development' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Shopify Migration',             url: 'https://www.miraclewebsoft.com/services/shopify-migration' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Conversion Rate Optimization',  url: 'https://www.miraclewebsoft.com/services/conversion-rate-optimization' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Shopify Speed Optimization',    url: 'https://www.miraclewebsoft.com/services/shopify-speed-optimization' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'CRO & Speed Optimization',     url: 'https://www.miraclewebsoft.com/services/shopify-cro-speed' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Custom Web Development',        url: 'https://www.miraclewebsoft.com/services/custom-web-development' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'White Label Shopify Development', url: 'https://www.miraclewebsoft.com/white-label' } },
        ],
      },
      founder: {
        '@type': 'Person',
    ...
    {
      '@type': 'WebSite',
      '@id': 'https://www.miraclewebsoft.com/#website',
      url: 'https://www.miraclewebsoft.com',
      name: 'Miracle Websoft',
      ...
      publisher: { '@id': 'https://www.miraclewebsoft.com/#organization' },
      potentialAction: {
        '@type': 'SearchAction',
        target: {
          '@type': 'EntryPoint',
          urlTemplate: 'https://www.miraclewebsoft.com/search?q={search_term_string}',
        },
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.miraclewebsoft.com/#navigation',
