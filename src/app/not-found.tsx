  ...
  return (
    <div style={{ background: '#0a0a0a', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '5rem' }}>
      <div className="mw-container text-center" style={{ maxWidth: '600px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '1rem', lineHeight: 1.8, marginBottom: '2.5rem', fontWeight: 300 }}>
        ...
        <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {[
              ...
              <Link key={l.href} href={l.href} style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', padding: '0.35rem 0.9rem', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '9999px', transition: 'all 0.2s' }}
