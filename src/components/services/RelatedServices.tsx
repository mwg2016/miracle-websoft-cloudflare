  ...
  return (
    <section style={{ paddingTop: '3rem', paddingBottom: '4rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="mw-container">
        <p style={{ fontSize: '0.68rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.30)', fontWeight: 600, marginBottom: '1rem' }}>
          You might also need
        </p>
          ...
          {services.map((s, i) => (
            ...
            >
              <div>
                ...
                <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>{s.desc}</p>
              </div>
