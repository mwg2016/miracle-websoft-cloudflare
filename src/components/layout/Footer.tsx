      ...
      <div className="mw-container" style={{ paddingTop: '1.25rem', paddingBottom: '1.25rem' }}>
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4" style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)' }}>
            <Link href="https://www.shopify.com/partners/directory/partner/miracle-websoft1" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Shopify Partner</Link>
            <span>·</span>
